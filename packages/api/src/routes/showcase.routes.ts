...
import { getShowcaseVideos, getAllShowcaseVideos, createShowcaseVideo, updateShowcaseVideo, deleteShowcaseVideo } from '../controllers/showcase.controller.js'

const router: IRouter = Router()

router.get('/', getShowcaseVideos)
router.get('/all', authenticate, requireRole('director'), getAllShowcaseVideos)
